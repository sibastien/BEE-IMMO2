...
const getFormData = () => ({
  ...
  context: document.getElementById('context').value.trim() || 'Client Bee Immobilier',
          ...
          <div class="property-content">
            <div class="property-header">
              <div>
                ...
                <p class="property-description">${escapeHtml(testimonial.context || 'Client Bee Immobilier')}</p>
              </div>
